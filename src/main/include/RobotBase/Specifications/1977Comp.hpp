	...
	namespace Module {
		...
		namespace Front {
			namespace Left {
				...
				static constexpr units::turn_t MagnetOffset = 0.320068_tr; //0.53516
			...
			namespace Right {
				...
				static constexpr units::turn_t MagnetOffset = 0.749512_tr;
				static const frc::Translation2d Location = {
					( + (((Measurements::Frame::length)/2) - Measurements::Wheel::offset)) - Measurements::Gyroscope::xPosition,
					( - (((Measurements::Frame::width)/2) + Measurements::Wheel::offset)) - Measurements::Gyroscope::yPosition
				};
		...
		namespace Rear {
			namespace Left {
				...
				static constexpr units::turn_t MagnetOffset = 0.573242_tr;
				static const frc::Translation2d Location = {
					( - (((Measurements::Frame::length)/2) + Measurements::Wheel::offset)) - Measurements::Gyroscope::xPosition,
					( + (((Measurements::Frame::width)/2) - Measurements::Wheel::offset)) - Measurements::Gyroscope::yPosition
				};
			...
			namespace Right {
				...
				static constexpr units::turn_t MagnetOffset = 0.241455_tr;	
				static const frc::Translation2d Location = {
					( - (((Measurements::Frame::length)/2) + Measurements::Wheel::offset)) - Measurements::Gyroscope::xPosition,
					( - (((Measurements::Frame::width)/2) + Measurements::Wheel::offset)) - Measurements::Gyroscope::yPosition
				};
